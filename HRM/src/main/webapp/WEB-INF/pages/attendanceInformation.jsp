...
<div id="d">
    ...
    <div id="d4">
        <form action="attendanceInformation" method="post">
    ...
    <div id="d3" style="font-size: 24px">
            ...
            <table >
                ...
                <c:forEach items="${attendances}" var="attendance" varStatus="loop">
                    <tr >
                        ...
                        <td>${attendance.staff.s_id}</td>
                        <td>${DateAndString.dateToString(attendance.a_date)}</td>
                        <td>${DateAndString.dateToStringTime(attendance.on_time)}</td>
                        <td>${attendance.off_time==null?"未打下班卡":DateAndString.dateToStringTime(attendance.off_time)}</td>
        ...
        <div id="d32" >
            <a href="attendanceInformation?d_id=${d_id}&j_id=${j_id}&currentPage=${currentPage-1==0?currentPage:currentPage-1}">上一页</a>
            <a href="attendanceInformation?d_id=${d_id}&j_id=${j_id}&currentPage=${currentPage}">第${currentPage}页</a>
            共${totalPages}页
            <a href="attendanceInformation?d_id=${d_id}&j_id=${j_id}&currentPage=${currentPage+1>totalPages?currentPage:currentPage+1}">下一页</a>
            <form action="attendanceInformation?d_id=${d_id}&j_id=${j_id}" method="post">
