...
<div id="d">
    ...
    <div id="d3" style="font-size: 24px">
        ...
        <div id="d32" >
            <a href="staffAttendance?s_id=${s_id}&currentPage=${currentPage-1==0?currentPage:currentPage-1}">上一页</a>
            <a href="staffAttendance?s_id=${s_id}&currentPage=${currentPage}">第${currentPage}页</a>
            共${totalPages}页
            <a href="staffAttendance?s_id=${s_id}&currentPage=${currentPage+1>totalPages?currentPage:currentPage+1}">下一页</a>
            <form action="staffAttendance?s_id=${s_id}" method="post">
